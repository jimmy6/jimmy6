...
public class GoogleSearchServiceLocator extends org.apache.axis.client.Service implements
	...
	public GoogleSearchServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (GoogleSearch.GoogleSearchPort.class.isAssignableFrom(serviceEndpointInterface)) {
				GoogleSearch.GoogleSearchBindingStub _stub = new GoogleSearch.GoogleSearchBindingStub(new java.net.URL(
