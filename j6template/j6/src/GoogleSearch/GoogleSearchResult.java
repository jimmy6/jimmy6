...
public class GoogleSearchResult implements java.io.Serializable {
	...
	public GoogleSearchResult(boolean documentFiltering, java.lang.String searchComments,
			int estimatedTotalResultsCount, boolean estimateIsExact, GoogleSearch.ResultElement[] resultElements,
			java.lang.String searchQuery, int startIndex, int endIndex, java.lang.String searchTips,
			GoogleSearch.DirectoryCategory[] directoryCategories, double searchTime) {
