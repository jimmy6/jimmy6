...
public class GoogleSearchBindingStub extends org.apache.axis.client.Stub implements GoogleSearch.GoogleSearchPort {
	...
	public GoogleSearchBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service)
	...
	public GoogleSearch.GoogleSearchResult doGoogleSearch(java.lang.String key, java.lang.String q, int start,
		...
		setAttachments(_call);
		try {
			java.lang.Object _resp = _call.invoke(new java.lang.Object[] { key, q, new java.lang.Integer(start),
					new java.lang.Integer(maxResults), new java.lang.Boolean(filter), restrict,
					new java.lang.Boolean(safeSearch), lr, ie, oe });
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					...
					return (GoogleSearch.GoogleSearchResult) org.apache.axis.utils.JavaUtils.convert(_resp,
							GoogleSearch.GoogleSearchResult.class);
				}
			}
		} catch (org.apache.axis.AxisFault axisFaultException) {
			throw axisFaultException;
